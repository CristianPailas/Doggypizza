 ...
 * @since 1.0.0
 */
class Pizzaro_Elementor_Pizzaro_Banner_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'pizzaro_elementor_pizzaro_banner';
    }
    ...
    public function get_title() {
        return esc_html__( 'Banner', 'pizzaro-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => Controls_Manager::TEXTAREA,
                'default'       => '',
                'placeholder'   => esc_html__( 'Enter condition', 'pizzaro-extensions' ),
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Pizzaro_Elementor_Pizzaro_Banner_Block );