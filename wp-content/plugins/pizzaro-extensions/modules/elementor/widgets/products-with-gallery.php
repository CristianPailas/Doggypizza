...
/**
 * Elementor Products with Gallery Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Pizzaro_Elementor_Pizzaro_Products_With_Gallery_Block extends Widget_Base {

    /**
     * Get widget name.
     *
     * Retrieve Products with Gallery widget name.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_name() {
        return 'pizzaro_elementor_pizzaro_products_with_gallery';
    }

    /**
     * Get widget title.
     *
     * Retrieve Products with Gallery widget title.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    public function get_title() {
        return esc_html__( 'Products with Gallery', 'pizzaro-extensions' );
    }

    /**
     * Get widget icon.
     *
     * Retrieve Products with Gallery widget icon.
     *
     * @since 1.0.0
     * @access public
     *
     ...
     *
     * Retrieve the list of categories the Products with Gallery widget belongs to.
     *
     * @since 1.0.0
     * @access public
     *
    ...
    /**
     * Register Products with Gallery widget controls.
     *
    ...
    /**
     * Render Products with Gallery output on the frontend.
     *
    ...
    protected function render() {
        ...
        if( function_exists( 'pizzaro_products_with_gallery_tabs' ) ) {
            pizzaro_products_with_gallery_tabs( $args );
        }
    }
}

Plugin::instance()->widgets_manager->register_widget_type( new Pizzaro_Elementor_Pizzaro_Products_With_Gallery_Block );